...
impl ApiServer {
  ...
  pub fn listen(&self, grpc_url: &String) {
    // if (!builder_) {
...
// impl BESSControl for BessCtl {
//   fn get_version(&self, request: Request<EmptyRequest>) -> Result<Response<VersionResponse>, Status> {
//     let reply = bess_pb::VersionResponse {
//       error: Error {code: 0, errmsg: ""},
